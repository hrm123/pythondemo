...
# Demonstrates different types of searches including similarity search, metadata filtering, and combinations of both.
# Implement similarity search using natural language queries. This demonstrates how Chroma DB can find semantically similar content.
def perform_advanced_search(collection, all_items):
    try:
        ...
        for i, (doc_id, document, distance) in enumerate(zip(
            ...
            #Now implement metadata filtering to find employees based on specific criteria.
        ...
        # Finally, combine similarity search with metadata filtering for more precise results.
